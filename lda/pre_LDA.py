...
with open('./sample.json', 'r', encoding = 'cp949') as f:
...
def find_optimal_number_of_topics(dictionary, corpus, processed_data):
    ...
    model_list, coherence_values = compute_cv(dictionary = dictionary, corpus = corpus, texts = processed_data, start = start, limit = limit, step = step)
...
if __name__ == '__main__':
    ...
    # LDA 시각화
    lda_model = gensim.models.LdaMulticore(corpus = corpus, id2word = dictionary, num_topics = 9, chunksize = 1000, passes = 5, alpha = 0.1, eta = 0.01)
